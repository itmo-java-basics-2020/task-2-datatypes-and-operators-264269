...
public class Task2 {
    ...
    boolean atLeastOneIsDigit(char c1, char c2, char c3) {
        if (((c1 > 47) && (c1 < 58)) || ((c2 > 47) && (c2 < 58)) || ((c3 > 47) && (c3 < 58))) {
           return true;
        }
        return false;
    }
    ...
    boolean areRealNumbersEqual(double a, double b) {
        return (a-b < 0.0000000000001); //your code here
    }
    ...
    int schoolDesks(int num1, int num2, int num3) {
        return (num1/2 + num2/2 + num3/2 + num1%2 + num2%2 + num3%2); //your code here
    }
